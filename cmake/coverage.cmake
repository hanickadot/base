...
function(enable_coverage)
	...
	elseif(CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
		...
		message(WARNING "Source level code coverage is supported only for Clang compiler! (CMAKE_CXX_COMPILER_ID = ${CMAKE_CXX_COMPILER_ID})")
		return()
	endif()
	
	SET(LLVM_COVERAGE_ENABLED ON PARENT_SCOPE)
